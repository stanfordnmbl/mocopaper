...
\begin{thebibliography}{10}
    ...
    \newblock {Design of patient-specific gait modifications for knee
    ...
    \newblock {Muscle synergies and complexity of neuromuscular control during gait
    in cerebral palsy}.
    ...
    \newblock {OpenEyeSim: A biomechanical model for simulation of closed-loop
    visual perception}.
    ...
    \newblock {Analysis of hindlimb muscle moment arms in Tyrannosaurus rex using a
    ...
    \newblock {Chimpanzee super strength and human skeletal muscle evolution}.
    ...
    \newblock {Generating dynamic simulations of movement using computed muscle
    control}.
    ...
    \bibitem{Lloyd:2003}
    Lloyd DG, Besier TF.
    \newblock {An EMG-driven musculoskeletal model to estimate muscle forces and
    knee joint moments in vivo}.
    ...
    \newblock {Musculoskeletal modelling deconstructs the paradoxical effects of
    ...
    \newblock {Optimization-Based Models of Muscle Coordination}.
    ...
    Geijtenbeek T.
    \newblock {SCONE: Open Source Software for Predictive Simulation of Biological
    Motion}.
    ...
    \newblock {Robotic lower limb prosthesis design through simultaneous computer
    optimizations of human and prosthesis costs}.
    ...
    \newblock {Dynamic Optimization of Human Walking}.
    \newblock Journal of Biomechanical Engineering. 2001;123(5):381--390.
    \newblock doi:{10.1115/1.1392310}.

    \bibitem{Lin:2017jp}
    Lin YC, Pandy MG.
    \newblock {Three-dimensional data-tracking dynamic optimization simulations of
    ...
    Todorov E, Li W.
    \newblock {Optimal control methods suitable for biomechanical systems}.
    ...
    \bibitem{Betts:2010}
    Betts JT.
    \newblock {Practical Methods for Optimal Control and Estimation Using Nonlinear
    Programming}.
    \newblock SIAM; 2010.

    \bibitem{Kelly:2017}
    Kelly M.
    \newblock {An Introduction to Trajectory Optimization: How to Do Your Own
    Direct Collocation}.
    ...
    \newblock {Solving Ordinary Differential Equations I, Nonstiff Problems}.
    \newblock Springer; 1993.

    \bibitem{Hairer:1996}
    Hairer E, Wanner G.
    \newblock {Solving Ordinary Differential Equations II, Stiff and
    ...
    \newblock {Knee abduction moment is predicted by lower gluteus medius force and
    ...
    \newblock {Predictive algorithms for neuromuscular control of human
    locomotion}.
    ...
    \newblock {Can Altered Muscle Synergies Control Unimpaired Gait?}
    ...
    \newblock {Joint contact forces can be reduced by improving joint moment
    symmetry in below-knee amputee gait simulations}.
    ...
    \newblock {Optimality principles for model-based prediction of human gait}.
    \newblock Journal of Biomechanics. 2010;43:1055--1060.
    \newblock doi:{10.1016/j.jbiomech.2009.12.012}.

    \bibitem{Ackermann:2012}
    Ackermann M, van~den Bogert AJ.
    \newblock {Predictive simulation of gait at low gravity reveals skipping as the
    ...
    Miller RH, Hamill J.
    \newblock {Optimal footfall patterns for cost minimization in running}.
    ...
    \newblock {Direct Methods for Predicting Movement Biomechanics Based Upon
    Optimal Control Theory with Implementation in OpenSim}.
    \newblock Annals of Biomedical Engineering. 2016;44:2542--2557.
    \newblock doi:{10.1007/s10439-015-1538-6}.

    \bibitem{Lee:2016dn}
    Lee LF, Umberger BR.
    \newblock {Generating optimal control simulations of musculoskeletal movement
    ...
    \newblock {Searching for strategies to reduce the mechanical demands of the
    ...
    \newblock {opty: Software for trajectory optimization and parameter
    identification using direct collocation}.
    \newblock The Journal of Open Source Software. 2018;3:300.
    \newblock doi:{10.21105/joss.00300}.

    \bibitem{Lin:2018ex}
    Lin YC, Walter JP, Pandy MG.
    \newblock {Predictive Simulations of Neuromuscular Coordination and
    ...
    \newblock {Metabolic cost underlies task-dependent variations in motor unit
    recruitment}.
    ...
    \newblock {Bilevel Optimization for Cost Function Determination in Dynamic
    ...
    \newblock {Rapid predictive simulations with complex musculoskeletal models
    ...
    \bibitem{Jansen:2020}
    Jansen C, McPhee J.
    \newblock {Predictive dynamic simulation of Olympic track cycling standing
    start using direct collocation optimal control}.
    ...
    \newblock {EMG-Driven Optimal Estimation of Subject-Specific Hill Model
    Muscle–Tendon Parameters of the Knee Joint Actuators}.
    ...
    \newblock {Optimal design and control of an electromechanical transfemoral
    ...
    \newblock {Implicit methods for efficient musculoskeletal simulation and
    optimal control}.
    ...
    \newblock {Metabolic cost calculations of gait using musculoskeletal energy
    models, a comparison study}.
    ...
    \newblock {Algorithmic differentiation improves the computational efficiency of
    ...
    Becerra VM.
    \newblock {Solving Complex Optimal Control Problems at No Cost with PSOPT}.
    \newblock 2010 IEEE International Symposium on Computer-Aided Control System
    ...
    \newblock {OpenSim: Simulating musculoskeletal dynamics and neuromuscular
    ...
    \newblock {Simbody: multibody dynamics for biomedical research}.
    \newblock Procedia IUTAM. 2011;2:241--261.
    \newblock doi:{10.1016/j.piutam.2011.04.023}.

    \bibitem{Posa:2016}
    Posa M, Tedrake R, Kuindersma S.
    \newblock {Optimization and Stabilization of Trajectories for Constrained
    Dynamical Systems}.
    \newblock 2016 IEEE International Conference on Robotics and Automation. 2016;
    p. 1366--1373.
    \newblock doi:{10.1109/icra.2016.7487270}.

    \bibitem{Seth:2016}
    Seth A, Matias R, Veloso AP, Delp SL.
    \newblock {A Biomechanical Model of the Scapulothoracic Joint to Accurately
    Capture Scapular Kinematics during Shoulder Movements}.
    \newblock PLoS ONE. 2016;11:e0141028.
    \newblock doi:{10.1371/journal.pone.0141028}.

    \bibitem{Lerner:2015}
    Lerner ZF, DeMers MS, Delp SL, Browning RC.
    \newblock {How tibiofemoral alignment and contact locations affect predictions
    of medial and lateral tibiofemoral contact forces}.
    ...
    \newblock {Cervical Spine Injuries: A Whole-Body Musculoskeletal Model for the
    Analysis of Spinal Loading}.
    ...
    \newblock {Subject-Exoskeleton Contact Model Calibration Leads to Accurate
    Interaction Force Predictions}.
    \newblock IEEE Transactions on Neural Systems and Rehabilitation Engineering.
    2019;27:1597--1605.
    ...
    \newblock {CasADi: a software framework for nonlinear optimization and optimal
    control}.
    ...
    \bibitem{Bryson:1975}
    Bryson AE, Ho YC.
    \newblock {Applied Optimal Control: Optimization, Estimation, and Control}.
    \newblock Washington: Hemisphere Pub. Corp; 1975.

    \bibitem{Perry:2010}
    Perry J, Burnfield J.
    \newblock {Gait Analysis: Normal and Pathological Function}.
    \newblock 2nd ed. Slack Incorporated; 2010.

    \bibitem{Whittington:2008jia}
    Whittington B, Silder A, Heiderscheit B, Thelen DG.
    \newblock {The contribution of passive-elastic mechanisms to lower extremity
    joint kinetics during human walking}.
    ...
    \newblock {Grand challenge competition to predict in vivo knee loads}.
    ...
    \newblock {Update on grand challenge competition to predict in vivo knee
    loads.}
    ...
    \newblock {Changes in tibiofemoral forces due to variations in muscle activity
    during walking}.
    ...
    \newblock {Computational Prediction of Muscle Moments During ARED Squat
    ...
    \bibitem{Yavuz:2017}
    Yavuz HU, Erdag D.
    \newblock {Kinematic and Electromyographic Activity Changes during Back Squat
    with Submaximal and Maximal Loading}.
    ...
    \newblock {Estimation of gait kinematics and kinetics from inertial sensor data
