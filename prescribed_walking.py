...
class MotionPrescribedWalking(MocoPaperResult):
    def __init__(self):
        ...
        self.mocoinverse_jointreaction_solution_file = \
            'results/motion_prescribed_walking_inverse_jointreaction_solution.sto'
        self.side = 'l'
    ...
    def create_model_processor(self):
        ...
        tasks.printToXML('motion_prescribed_walking_cmc_tasks.xml')
    ...
    def generate_results(self, args):
        ...
        cmc = osim.CMCTool('motion_prescribed_walking_cmc_setup.xml')
        # 2.5 minute
        if self.cmc:
            cmc.run()
    ...
    def report_results(self, args):
        ...
        if self.cmc:
            sol_cmc = osim.TimeSeriesTable('results/motion_prescribed_walking_cmc_results/'
        ...
        if plot_breakdown:
            ...
            fig.savefig('results/motion_prescribed_walking_inverse_'
        ...
        fig.savefig('figures/motion_prescribed_walking_kinematics.png', dpi=600)
        ...
        image = cv2.imread('figures/motion_prescribed_walking_inverse_model.png')[
                ..., ::-1]
        ax.imshow(image)
        plt.axis('off')
        ...
        fig.savefig('figures/motion_prescribed_walking.eps')
        fig.savefig('figures/motion_prescribed_walking.pdf')
        fig.savefig('figures/motion_prescribed_walking.png', dpi=600)
        ...
        if self.cmc and self.inverse:
            ...
            with open('results/motion_prescribed_walking_'
